<script type="text/javascript">  
        ...
        function checkPass()
        {
			...
			else if(document.getElementById("password").value.length<8)
			{
			  	document.getElementById("password").style.borderColor = "red";
			  	document.getElementById("passErr").style.color = "red";
				document.getElementById("passErr").innerHTML = "Password have to be at least 8 characters!";
			}			
			else
			{
        ...
        function checkConfirmpassword()
        {
			...
			}else if(document.getElementById("confirmpassword").value.length<8)
			{
			  	document.getElementById("confirmpassword").style.borderColor = "red";
			  	document.getElementById("confirmpasswordErr").style.color = "red";
				document.getElementById("confirmpasswordErr").innerHTML = "Confirm password have to be at least 8 characters!";
			}
			else if(document.getElementById("confirmpassword").value !== document.getElementById("password").value)
			{
			  	document.getElementById("confirmpassword").style.borderColor = "red";
			  	document.getElementById("confirmpasswordErr").style.color = "red";
				document.getElementById("confirmpasswordErr").innerHTML = "Password & Confirm password have to be same!";
			}
			else{
			  	document.getElementById("confirmpasswordErr").style.color = "red";
